...
NODE_ES.update({
    "HC_APPELLATION_RULES_ORIGIN_VALUE": {"subject": "las reglas de origen, la tipicidad y el valor percibido", "causa": "Una indicación geográfica define un origen y reglas de producción permitidas.", "mecanismo": "La trazabilidad y el cumplimiento protegen el nombre y crean una promesa reconocible; las categorías amplias suelen permitir más flexibilidad.", "efecto": "La denominación puede sostener tipicidad, reconocimiento y valor percibido sin garantizar cada botella."},
    "HC_TULIP_GLASS_AROMA_CONCENTRATION": {"subject": "la copa en forma de tulipán para vinos aromáticos", "causa": "Un blanco aromático se sirve en una copa cuyo cáliz es más ancho que la abertura.", "mecanismo": "El cáliz libera compuestos volátiles y la boca más estrecha dirige y concentra los aromas hacia la nariz.", "efecto": "Los aromas primarios delicados pueden evaluarse con mayor claridad."},
    "HC_SERVICE_TEMPERATURE_GLASS_PROTOCOL": {"subject": "la temperatura, la copa y el protocolo de servicio", "causa": "El vino se prepara con temperatura elegida, cristalería limpia y presentación ordenada.", "mecanismo": "La temperatura cambia aroma y estructura, la copa dirige aromas y el protocolo reduce errores de manipulación.", "efecto": "El vino se presenta de forma coherente y adecuada a su estilo."},
    "HC_COONAWARRA_TERRA_ROSSA_MODERATION": {"subject": "la terra rossa y la moderación climática de Coonawarra", "causa": "Los viñedos combinan terra rossa sobre caliza con influencia moderadora del océano Austral.", "mecanismo": "El perfil del suelo aporta drenaje y agua en profundidad, mientras el clima ralentiza la maduración y limita calor excesivo.", "efecto": "Cabernet Sauvignon puede madurar con concentración, frescura y estructura firme."},
    "HC_DOURO_TERRACES_SLOPE_ACCESS": {"subject": "los bancales en las laderas del Douro", "causa": "Las pendientes son demasiado pronunciadas para un cultivo sencillo sobre la superficie natural.", "mecanismo": "Los bancales crean franjas plantables, facilitan acceso y manejo de erosión y conservan la exposición de la ladera.", "efecto": "Permiten cultivar viñedos soleados y empinados, aunque con costes y trabajo elevados."},
    "HC_BURGUNDY_SITE_HIERARCHY_CONCENTRATION": {"subject": "la jerarquía de sitio y la concentración en Borgoña", "causa": "Un Premier Cru procede de un viñedo delimitado, no de la denominación regional amplia.", "mecanismo": "La mayor especificidad del sitio y reglas más estrictas preservan uvas de lugares con historial de maduración y expresión.", "efecto": "Suele mostrar más concentración, complejidad y capacidad de guarda que un Bourgogne regional."},
    "HC_NEGOCIANT_BLEND_MATURATION_ROLE": {"subject": "el papel del négociant en mezcla y crianza", "causa": "El comerciante compra uvas, mostos o vinos y asume selección, ensamblaje, crianza o embotellado.", "mecanismo": "Elegir lotes y controlar mezcla y maduración permite modelar consistencia, estructura y estilo comercial.", "efecto": "El intermediario puede influir activamente en el vino final y no sólo revenderlo."},
    "HC_HARVEST_BRIX_RIPENESS_DECISION": {"subject": "el índice Brix y la decisión de vendimia", "causa": "Se miden sólidos solubles del jugo de uva, expresados como Brix o escala equivalente.", "mecanismo": "Los sólidos reflejan principalmente azúcar y orientan sobre alcohol potencial y una parte de la madurez.", "efecto": "La medida ayuda a decidir la cosecha junto con acidez, sabor, madurez fenólica y riesgo meteorológico."},
    "HC_SULFITE_ALLERGEN_LABEL_THRESHOLD": {"subject": "la declaración de sulfitos como alérgeno", "causa": "Un vino comercializado en la UE supera el umbral legal de declaración de sulfitos.", "mecanismo": "Los sulfitos pueden causar reacciones en personas sensibles y la norma exige información visible por encima del umbral.", "efecto": "La etiqueta declara que contiene sulfitos para informar al consumidor."},
    "HC_BAG_IN_BOX_COLLAPSIBLE_OXYGEN": {"subject": "el bag-in-box y el control de aire al servir", "causa": "Un vino joven se envasa en una bolsa flexible con grifo dentro de una caja.", "mecanismo": "La bolsa colapsa al dispensar y limita el aire de reemplazo, mientras el envase ligero reduce costes de transporte y servicio.", "efecto": "Es práctico para vinos cotidianos y conserva mejor un envase abierto durante un periodo limitado."},
    "HC_ALSACE_VARIETAL_LABEL_DRY_CLIMATE": {"subject": "el etiquetado varietal y el clima seco de Alsacia", "causa": "Alsacia está a sotavento de los Vosgos y suele etiquetar por la variedad principal.", "mecanismo": "La sombra pluviométrica favorece una temporada seca y soleada, mientras la etiqueta comunica directamente la identidad de la uva.", "efecto": "La región se asocia con blancos maduros de expresión varietal y etiquetas centradas en la uva."},
    "HC_BRAND_CONSISTENCY_EXPORT_SUCCESS": {"subject": "la imagen de marca consistente y el éxito exportador", "causa": "Los productores comunican una imagen regional reconocible y un estilo relativamente consistente.", "mecanismo": "El posicionamiento claro reduce incertidumbre, favorece recompra y facilita el mensaje de distribuidores.", "efecto": "Una imagen moderna y coherente puede acelerar reconocimiento y éxito en exportación."},
})
...
MANUAL_REVIEW_PROMOTIONS.update({
    "wset3_63": {"node_id": "HC_OAKED_WHITE_SERVICE_TEMPERATURE", "reason": "Enfriar preserva frescura y una decantación opcional puede abrir un blanco complejo o separar depósito.", "caveat": "No todo blanco de gama alta necesita decantación; debe decidirse según estilo, edad, reducción y sedimento."},
    "wset3_97": {"node_id": "HC_OLOROSO_AMONTILLADO_AGEING_PATH", "reason": "Oloroso completa la fermentación seca antes de fortificarse a un grado que impide el desarrollo de flor.", "caveat": "La fortificación posterior no es exclusiva de Oloroso; la respuesta depende del contraste con estilos fortificados durante fermentación."},
    "wset3_105": {"node_id": "HC_OLOROSO_AMONTILLADO_AGEING_PATH", "reason": "Palo Cortado combina finura inicial con una fase oxidativa prolongada, explicando su complejidad intensa.", "caveat": "La clasificación depende de la evolución y selección en bodega; no existe una única receta aromática."},
    "wset3_121": {"node_id": "HC_TRADITIONAL_BOTTLE_SECOND_FERMENTATION", "reason": "Champagne genera sus burbujas mediante una segunda fermentación en la botella final.", "caveat": "El método tradicional incluye además crianza sobre lías, removido, degüelle y dosificación."},
    "wset3_211": {"node_id": "HC_APPASSIMENTO_GRAPE_DRYING_CONCENTRATION", "reason": "El secado de Pedro Ximénez concentra azúcar y permite un Jerez naturalmente muy dulce.", "caveat": "El dulzor final también depende de fermentación, fortificación y ensamblaje; otros Jereces pueden endulzarse."},
    "wset3_213": {"node_id": "HC_PRESSURE_MOUSSE_INTENSITY", "reason": "La segunda fermentación en botella genera CO2 retenido y presiones cercanas a 5-6 atm en Champagne.", "caveat": "La presión exacta varía por estilo, temperatura y especificación de producción."},
    "wset3_235": {"node_id": "HC_WARM_CLIMATE_RIPE_FRUIT_ALCOHOL", "reason": "La madurez de Pinotage en zonas cálidas explica fruta madura y cuerpo, mientras fermentación y roble pueden aportar humo.", "caveat": "El carácter ahumado no es inherente ni obligatorio; productor, sitio y manejo microbiológico cambian mucho el estilo."},
    "wset3_237": {"node_id": "HC_TRADITIONAL_BOTTLE_SECOND_FERMENTATION", "reason": "La fermentación secundaria en botella explica la producción de burbujas de Champagne.", "caveat": "No basta con decir segunda fermentación: crianza sobre lías y eliminación del sedimento completan el método."},
    "wset3_250": {"node_id": "HC_COOL_CLIMATE_STYLE", "reason": "El norte del Ródano relativamente fresco conserva acidez y favorece Syrah de cuerpo medio y especias.", "caveat": "Crozes-Hermitage es amplio; exposición, rendimiento, extracción y crianza producen estilos desde ligeros hasta concentrados."},
    "wset3_256": {"node_id": "HC_COOL_CLIMATE_STYLE", "reason": "El clima fresco de Chablis conserva acidez y limita madurez exuberante, sosteniendo un perfil seco y tenso.", "caveat": "“Mineralidad” es una descripción sensorial, no transferencia literal del suelo; algunos Chablis usan roble."},
    "wset3_260": {"node_id": "HC_CONTINENTALITY_STYLE", "reason": "La maduración continental de Nebbiolo conserva acidez y tanino, y la evolución aporta notas especiadas y de alquitrán.", "caveat": "Gattinara varía por sitio, añada y crianza; esos descriptores no aparecen con igual intensidad en todo vino."},
    "wset3_267": {"node_id": "HC_APPELLATION_RULES_ORIGIN_VALUE", "reason": "La protección de origen y las reglas reconocibles pueden elevar confianza y valor percibido.", "caveat": "Una denominación no garantiza calidad individual ni precio alto; reputación, productor y demanda siguen siendo decisivos."},
    "wset3_268": {"node_id": "HC_RED_WINE_AGEABILITY_STRUCTURE", "reason": "Nebbiolo joven conserva acidez alta y taninos firmes, con aromas florales antes del desarrollo terciario.", "caveat": "La extracción, madurez y procedencia modifican la dureza y el perfil aromático del vino joven."},
    "wset3_272": {"node_id": "HC_RED_WINE_AGEABILITY_STRUCTURE", "reason": "Tannat aporta color y tanino abundantes, explicando la estructura potente de Madiran.", "caveat": "Mezcla, microoxigenación, extracción y madurez pueden suavizar o intensificar esa estructura."},
    "wset3_276": {"node_id": "HC_COONAWARRA_TERRA_ROSSA_MODERATION", "reason": "Terra rossa sobre caliza y clima moderado explican drenaje, maduración gradual y estructura fresca.", "caveat": "La asociación no implica sabor directo del suelo ni uniformidad entre todos los viñedos."},
    "wset3_280": {"node_id": "HC_STAINLESS_PRIMARY_AROMA_PRESERVATION", "reason": "Fermentación protegida y fresca conserva el perfil herbal y frutal de Verdejo, con cuerpo moderado.", "caveat": "Rueda también produce estilos con lías, roble y diferentes proporciones varietales."},
    "wset3_290": {"node_id": "HC_BORDEAUX_BLEND_VINTAGE_VARIATION", "reason": "El ensamblaje dominado por Merlot puede combinar fruta negra y estructura media, con roble integrado por crianza.", "caveat": "Saint-Émilion Grand Cru cubre productores y suelos diversos; la categoría no fija un único perfil."},
    "wset3_293": {"node_id": "HC_WARM_CLIMATE_RIPE_FRUIT_ALCOHOL", "reason": "El clima cálido favorece Garnacha madura con fruta roja intensa, alcohol y especias en Campo de Borja.", "caveat": "Altitud, edad de viña, cosecha y crianza pueden conservar frescura o cambiar la concentración."},
    "wset3_295": {"node_id": "HC_RED_WINE_AGEABILITY_STRUCTURE", "reason": "Mourvèdre madura tarde y puede aportar tanino, color y estructura para guarda en Bandol.", "caveat": "La mezcla, el rendimiento, la exposición y la crianza determinan cuánto potencial se realiza."},
    "wset3_299": {"node_id": "HC_DOURO_TERRACES_SLOPE_ACCESS", "reason": "Los bancales convierten laderas muy empinadas en superficies cultivables y accesibles.", "caveat": "Existen terrazas tradicionales y modernas con efectos distintos sobre densidad, erosión y mecanización."},
    "wset3_307": {"node_id": "HC_ALSACE_VARIETAL_LABEL_DRY_CLIMATE", "reason": "La sombra de lluvia de los Vosgos explica clima seco y el etiquetado varietal comunica la uva principal.", "caveat": "El dulzor y estilo no se deducen sólo de la variedad; etiqueta, productor y añada requieren lectura adicional."},
    "wset3_313": {"node_id": "HC_CONTINENTALITY_STYLE", "reason": "Altitud y continentalidad favorecen Tempranillo con tanino y concentración, que suele integrarse mediante roble.", "caveat": "Ribera del Duero incluye estilos modernos y tradicionales; el roble no explica por sí solo la estructura."},
    "wset3_314": {"node_id": "HC_PROTEIN_FAT_TANNIN_SOFTENING", "reason": "Intensidad y textura del queso determinan cuánto grasa, proteína, sal y sabor interactúan con el vino.", "caveat": "No existe un maridaje único para “queso”; maduración, corteza, sal y acompañamientos cambian la elección."},
    "wset3_324": {"node_id": "HC_OAK_AGEING_COMPLEXITY", "reason": "La crianza en roble aporta oxígeno gradual e integración estructural que puede sostener longevidad.", "caveat": "El origen americano del roble influye sobre todo en aroma; fruta, acidez, tanino y almacenamiento determinan la guarda."},
    "wset3_327": {"node_id": "HC_MECHANIZATION_PRODUCTION_COST", "reason": "Escala, rendimientos y mecanización pueden reducir coste por botella y sostener vinos de buen valor.", "caveat": "Bajo coste no equivale a alta calidad; tierra, transporte, marca y selección también afectan el precio."},
    "wset3_332": {"node_id": "HC_UMAMI_BITTER_ACID_PERCEPTION", "reason": "El umami puede aumentar amargor y dureza percibidos, por lo que alta acidez y poco alcohol reducen el choque.", "caveat": "Sal, grasa y proteína del plato pueden cambiar el resultado y permitir otros estilos."},
    "wset3_337": {"node_id": "HC_BURGUNDY_SITE_HIERARCHY_CONCENTRATION", "reason": "Un sitio Premier Cru más específico y rendimientos controlados suelen sostener mayor concentración y complejidad.", "caveat": "La jerarquía no garantiza superioridad de cada botella; productor, añada y conservación siguen siendo esenciales."},
    "wset3_343": {"node_id": "HC_RED_WINE_AGEABILITY_STRUCTURE", "reason": "Touriga Nacional aporta aroma floral, color y tanino, explicando intensidad y estructura en Douro DOC.", "caveat": "La mezcla, madurez, extracción y crianza modifican el perfil; no todos los Douro son varietales."},
    "wset3_348": {"node_id": "HC_NEGOCIANT_BLEND_MATURATION_ROLE", "reason": "La selección de lotes, mezcla y crianza por comerciantes puede modelar el estilo final de Bordeaux.", "caveat": "Hoy esas funciones también pueden realizarlas châteaux y otras empresas; el comercio no determina un único estilo."},
    "wset3_374": {"node_id": "HC_ALTITUDE_SLOW_RIPENING_FRESHNESS", "reason": "Latitud septentrional y sitios elevados reducen temperatura y ayudan a conservar acidez durante la maduración.", "caveat": "Alemania contiene valles bajos y zonas cálidas; exposición, río y añada pueden ser más importantes que la altitud."},
    "wset3_383": {"node_id": "HC_APPELLATION_RULES_ORIGIN_VALUE", "reason": "La DOP protege un origen delimitado y sus reglas de producción frente a uso indebido.", "caveat": "Proteger origen y tipicidad no equivale a certificar que toda botella tenga la misma calidad."},
    "wset3_395": {"node_id": "HC_MARITIME_MODERATION", "reason": "La moderación andina y nocturna puede conservar acidez mientras Cabernet desarrolla grosella negra y tanino.", "caveat": "Maipo contiene sectores cálidos y frescos; riego, cosecha, extracción y roble cambian el perfil."},
    "wset3_412": {"node_id": "HC_SCARCITY_DEMAND_PRICE_PRESSURE", "reason": "Reputación global y marketing elevan demanda y disposición a pagar por Napa Valley.", "caveat": "Tierra, mano de obra, rendimientos y crianza también elevan costes; marketing no demuestra calidad intrínseca."},
    "wset3_419": {"node_id": "HC_BRAND_CONSISTENCY_EXPORT_SUCCESS", "reason": "Una imagen moderna y un estilo reconocible reducen incertidumbre y favorecen recompra y distribución.", "caveat": "El éxito de Marlborough también depende de Sauvignon Blanc, inversión, logística y mercados; no todos los productores son iguales."},
    "wset3_423": {"node_id": "HC_SOLAR_EXPOSURE_RED_COLOR", "reason": "La fuerte insolación favorece fotosíntesis y madurez de pieles, sosteniendo fruta y estructura en Stellenbosch.", "caveat": "La influencia marítima, altitud, viento y agua moderan el calor; insolación excesiva puede causar estrés."},
    "wset3_425": {"node_id": "HC_MODERATE_WATER_STRESS_PHENOLICS", "reason": "La escasez estival de lluvia puede limitar vigor y tamaño de baya, aumentando concentración si el estrés es moderado.", "caveat": "Toscana no es uniforme y sequía severa bloquea maduración; suelo, reservas hídricas y añada son decisivos."},
    "wset3_456": {"node_id": "HC_SANDY_SOIL_DRAINAGE", "reason": "Los suelos arenosos drenan rápido y suelen retener menos agua y nutrientes, limitando vigor y cuerpo potencial.", "caveat": "No producen siempre vinos ligeros; clima, riego, variedad, rendimiento y profundidad del suelo pueden invertir la tendencia."},
    "wset3_508": {"node_id": "HC_HARVEST_BRIX_RIPENESS_DECISION", "reason": "Brix estima azúcar y alcohol potencial, por lo que informa el momento de cosecha.", "caveat": "La decisión segura también requiere acidez, sabor, tanino, sanidad y previsión meteorológica."},
    "wset3_512": {"node_id": "HC_SHORT_CYCLE_VARIETY_COOL_SEASON_FIT", "reason": "La genética varietal determina fechas de brotación, floración, envero y madurez, afectando la duración del ciclo.", "caveat": "Temperatura, agua, carga y manejo modifican el calendario; la variedad no actúa de forma aislada."},
    "wset3_517": {"node_id": "HC_SO2_MICROBIAL_INHIBITION", "reason": "Poblaciones autóctonas diversas incluyen cepas menos tolerantes al SO2 que una levadura seleccionada para fermentar.", "caveat": "La sensibilidad varía entre especies y cepas; pH, dosis y momento de adición determinan el efecto."},
    "wset3_657": {"node_id": "HC_WARM_CLIMATE_RIPE_FRUIT_ALCOHOL", "reason": "El calor de Barossa favorece Shiraz madura, concentración, alcohol y especias.", "caveat": "Edad de viña, subregión, rendimiento, cosecha y roble producen estilos más frescos o más potentes."},
    "wset3_712": {"node_id": "HC_EXCLUSIVE_DISTRIBUTOR_MARKET_ACCESS", "reason": "Distribución exclusiva, reputación y críticas pueden restringir acceso y elevar demanda y margen.", "caveat": "Las puntuaciones influyen en mercado, no en coste directo de producción ni calidad garantizada."},
    "wset3_728": {"node_id": "HC_MARITIME_MODERATION", "reason": "El mar modera temperatura, la exposición aporta luz y el drenaje evita saturación radicular, favoreciendo madurez equilibrada.", "caveat": "La calidad no se deriva automáticamente de esa combinación; variedad, agua, viento y manejo siguen siendo esenciales."},
    "wset3_729": {"node_id": "HC_APPELLATION_RULES_ORIGIN_VALUE", "reason": "La legislación delimita prácticas de viñedo y bodega para preservar una expresión reconocible del origen.", "caveat": "La tipicidad regulada permite variación y no debe confundirse con uniformidad ni superioridad automática."},
    "wset3_730": {"node_id": "HC_TULIP_GLASS_AROMA_CONCENTRATION", "reason": "La copa tulipán libera aromas en el cáliz y los concentra en una abertura más estrecha.", "caveat": "Limpieza, volumen servido y temperatura importan tanto como la forma exacta de la copa."},
    "wset3_735": {"node_id": "HC_SERVICE_TEMPERATURE_GLASS_PROTOCOL", "reason": "Temperatura, copa y presentación controlan percepción, seguridad y consistencia del servicio.", "caveat": "Los parámetros se ajustan al estilo y contexto; no existe una temperatura o copa universal."},
    "wset3_822": {"node_id": "HC_APPELLATION_RULES_ORIGIN_VALUE", "reason": "La IGP protege origen con reglas más amplias, permitiendo más variedades y métodos que una DOP.", "caveat": "La flexibilidad exacta depende de cada pliego y no implica menor calidad en toda botella."},
    "wset3_827": {"node_id": "HC_SULFITE_ALLERGEN_LABEL_THRESHOLD", "reason": "La UE exige declarar sulfitos sobre el umbral porque son alérgenos potenciales regulados.", "caveat": "La mención no indica una dosis peligrosa para la mayoría ni distingue sulfitos añadidos de los generados naturalmente."},
    "wset3_833": {"node_id": "HC_APPELLATION_RULES_ORIGIN_VALUE", "reason": "La AOC comunica origen delimitado y cumplimiento de sus normas de producción.", "caveat": "La etiqueta no certifica una puntuación ni garantiza que cada productor alcance el mismo nivel cualitativo."},
    "wset3_851": {"node_id": "HC_BAG_IN_BOX_COLLAPSIBLE_OXYGEN", "reason": "La bolsa colapsable limita entrada de aire y el formato ligero favorece practicidad y precio en vinos jóvenes.", "caveat": "No está pensado para guarda larga; la vida útil depende de barrera del envase, llenado y almacenamiento."},
})
...
def derive() -> dict:
    ...
    return {
        ...
        "phase": "P.8-batch8-manual-review",
        "derivation": {

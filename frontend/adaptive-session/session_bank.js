window.SESSION_BANK = {
  ...
  "generated_at": "2026-06-12T00:43:03.350088",
  "total_sba": 578,
  "total_sat_prompts": 6,
  "modes": {
    "express_10": {
    ...
    "sat_sprint": {
      "type": "sat",
      "wines": 1,
      "label": "SAT Sprint · 1 vino"
    },
    "sat_practice": {
      "type": "sat",
      "wines": 2,
      "label": "SAT Practice · 2 vinos"
    },
    "sat_mock": {
      "type": "sat",
      "wines": 2,
  ...
  "sat_prompts": [
    {
      ...
      "description": "Vino blanco de color amarillo limón pálido. En nariz: intensidad media(+), aromas primarios de limón, melocotón y melón, aromas secundarios de vainilla y galleta, aromas terciarios de miel. En evolución. En boca: seco, acidez media(+), alcohol medio, cuerpo medio(+), intensidad media(+), final medio(+).",
      "wine_type": "white",
      "is_simple": false,
    ...
    },
    {
      ...
      "description": "Vino tinto de color rubí granate. En nariz: intensidad pronunciada, aromas primarios de cereza roja, frambuesa, grosella, violeta; aromas secundarios de vainilla, cedro, clavo; aromas terciarios de tierra, cuero, fruta seca. En evolución. En boca: seco, acidez alta, tanino medio, alcohol alto, cuerpo medio(+), intensidad pronunciada, final largo.",
      "wine_type": "red",
      "is_simple": false,
    ...
    },
    {
      ...
      "description": "Vino blanco de color amarillo pálido. En nariz: intensidad media(-), simple, aromas primarios de pera, manzana verde, melocotón blanco. Joven. En boca: seco, acidez media, alcohol bajo, cuerpo ligero, intensidad media(-), final corto.",
      "wine_type": "white",
      "is_simple": true,
    ...
    },
    {
      ...
      "description": "Vino blanco de color oro profundo. En nariz: intensidad pronunciada, en evolución, aromas primarios de flor de saúco, melocotón, albaricoque, piña, mango; frutas cocidas, pasas; aromas secundarios de vainilla, clavo, cedro; aromas terciarios de miel, almendra, mermelada, albaricoque seco. En boca: dulce, acidez alta, alcohol medio(+), cuerpo pleno, intensidad pronunciada, final largo.",
      "wine_type": "sweet",
      "is_simple": false,
      "expected_quality": "excelente",
      "expected_readiness": "se puede beber ahora, pero tiene potencial para el envejecimiento",
    ...
    },
    {
      ...
      "description": "Vino tinto de color rubí de intensidad media. En nariz: intensidad media, simple, aromas primarios de fresa, cereza, ciruela roja. Joven. En boca: seco, acidez media, tanino bajo, alcohol medio, cuerpo medio(-), intensidad media(-), final corto.",
      "wine_type": "red",
      "is_simple": true,
      "expected_quality": "aceptable",
      "expected_readiness": "beber ahora: no adecuado para el envejecimiento o para un mayor envejecimiento",
    ...
    },
    {
      ...
      "description": "Vino blanco de color amarillo verdoso pálido. En nariz: intensidad pronunciada, aromas primarios de pomelo, lima, hierba recién cortada, manzana verde; aromas secundarios de levadura, pan tostado (de lías); sin terciarios. Joven. En boca: seco, acidez alta, alcohol medio, cuerpo medio, intensidad pronunciada, final largo.",
      "wine_type": "white",
      "is_simple": false,
      "expected_quality": "muy bueno",
      "expected_readiness": "beber ahora: no adecuado para el envejecimiento o para un mayor envejecimiento",
